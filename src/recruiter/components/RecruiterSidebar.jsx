    ...
    >
      ...
      <div className="px-3 mb-4">
        <Link to="/recruiter/post-job">
          <motion.button
            className="w-full bg-gradient-to-r from-teal-500 to-purple-600 text-white px-4 py-3 rounded-lg font-medium flex items-center justify-center space-x-2 shadow-lg shadow-teal-500/25"
