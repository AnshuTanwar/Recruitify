  ...
  return (
    <>
      ...
      <motion.div
        ...
        initial={false}
        animate={{ x: isMobileMenuOpen || (typeof window !== 'undefined' && window.innerWidth >= 1024) ? 0 : -264 }}
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  {item.count && (
                    <motion.span
                      className="bg-teal-500 text-white text-xs px-1.5 sm:px-2 py-0.5 sm:py-1 rounded-full font-medium min-w-[20px] text-center"
                      initial={{ scale: 0 }}
                      animate={{ scale: 1 }}
      ...
      <div className="p-3 sm:p-4 border-t border-white/10 flex-shrink-0">
        <div className="flex items-center space-x-2 sm:space-x-3">
          <div className="flex items-center space-x-2 sm:space-x-3 p-2 sm:p-3 rounded-lg bg-white/5 hover:bg-white/10 transition-all duration-300 flex-1">
            <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-gradient-to-br from-teal-500 to-purple-600 flex items-center justify-center flex-shrink-0">
              <User className="w-4 h-4 sm:w-5 sm:h-5 text-white" />
            </div>
            <div className="flex-1 hidden lg:block min-w-0">
              <p className="text-sm font-medium text-white truncate">Esther Howard</p>
