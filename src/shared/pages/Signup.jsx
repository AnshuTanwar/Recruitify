...
const Signup = () => {
  ...
  return (
    <motion.div
      ...
      className="min-h-screen flex items-center justify-center px-4 py-8 pt-20"
    >
      <div className="w-full max-w-md">
        ...
        >
          <h1 className="text-4xl font-bold text-white mb-4 bg-gradient-to-r from-teal-400 to-purple-400 bg-clip-text text-transparent">
            Join the Future
          </h1>
        ...
        <Card className="relative overflow-hidden">
          <motion.div
            className="absolute inset-0 bg-gradient-to-br from-purple-500/20 to-teal-600/20 rounded-xl"
            animate={{
              background: [
                  ...
                  >
                    <div className="flex flex-col items-center text-center">
                      <User className={`w-8 h-8 mb-2 ${
                        formData.role === 'candidate' ? 'text-teal-400' : 'text-white/70'
                      }`} />
                      <span className={`font-medium ${
                        formData.role === 'candidate' ? 'text-teal-400' : 'text-white'
                      }`}>
                        Candidate
                      </span>
                  ...
                  >
                    <div className="flex flex-col items-center text-center">
                      <Building2 className={`w-8 h-8 mb-2 ${
                        formData.role === 'recruiter' ? 'text-purple-400' : 'text-white/70'
                      }`} />
                      <span className={`font-medium ${
                        formData.role === 'recruiter' ? 'text-purple-400' : 'text-white'
                      }`}>
                        Recruiter
                      </span>
                      <span className="text-xs text-white/60 mt-1">
