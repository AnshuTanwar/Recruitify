...
function Sidebar({ isMobileMenuOpen, onMobileClose }) {
  ...
  return (
    <>
      ...
      >
      {/* Logo Section */}
      <div className="p-3 xs:p-4 sm:p-5 lg:p-6 border-b border-white/10">
        <motion.div
        ...
        >
          ...
          >
            <div className="w-8 h-8 xs:w-9 xs:h-9 sm:w-10 sm:h-10 rounded-lg bg-gradient-to-br from-teal-500 to-purple-600 flex items-center justify-center shadow-lg shadow-teal-500/25">
              <Zap className="w-4 h-4 xs:w-5 xs:h-5 sm:w-6 sm:h-6 text-white" />
            </div>
          </motion.div>
          <div className="min-w-0">
            <h1 className="text-base xs:text-lg sm:text-xl font-bold bg-gradient-to-r from-white via-teal-200 to-purple-200 bg-clip-text text-transparent truncate">
              Recruitify
            </h1>
      ...
      {/* Dashboard Label */}
      <div className="px-3 xs:px-4 sm:px-5 lg:px-6 py-3 xs:py-3.5 sm:py-4">
        <h2 className="text-xs font-semibold text-white/50 uppercase tracking-wider hidden sm:block">
          Candidate Dashboard
        </h2>
        <h2 className="text-xs font-semibold text-white/50 uppercase tracking-wider sm:hidden">
          Dashboard
        </h2>
      </div>
